...
(function(){
  ...
  async function run(){
    ...
    (function(){
      ...
      ok("сейв: при отказе показано предупреждение", !!document.getElementById("saveWarn"));
      ok("сейв: после восстановления хранилища save() снова успешен", save()===true);
      ok("сейв: предупреждение убрано после успешного сохранения", !document.getElementById("saveWarn"));
    })();
